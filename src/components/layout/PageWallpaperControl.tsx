...
export function PageWallpaperControl() {
  ...
  return (
    <div className="fixed right-4 top-20 z-[60] font-sans">
      ...
      {open && (
        <div className="mt-2.5 max-h-[min(76vh,640px)] w-[min(23rem,calc(100vw-2rem))] overflow-y-auto rounded-2xl border border-white/12 bg-slate-950 p-3 shadow-[0_18px_48px_rgb(0_0_0/0.4)]">
